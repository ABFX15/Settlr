...
__export(index_exports, {
  ...
  DELEGATION_PROGRAM_ID: () => DELEGATION_PROGRAM_ID,
  ER_ENDPOINTS: () => ER_ENDPOINTS,
  MAGIC_ROUTER_DEVNET: () => MAGIC_ROUTER_DEVNET,
  OneClickClient: () => OneClickClient,
  PERMISSION_PROGRAM_ID: () => PERMISSION_PROGRAM_ID,
  PER_ENDPOINT: () => PER_ENDPOINT,
  PER_WS_ENDPOINT: () => PER_WS_ENDPOINT,
  ...
  buildDelegateAccounts: () => buildDelegateAccounts,
  buildPaymentPermissions: () => buildPaymentPermissions,
  buildPrivatePaymentAccounts: () => buildPrivatePaymentAccounts,
  createBaseConnection: () => createBaseConnection,
  createOneClickClient: () => createOneClickClient,
  createPERConnection: () => createPERConnection,
  createPayoutClient: () => createPayoutClient,
  createSubscriptionClient: () => createSubscriptionClient,
  createWebhookHandler: () => createWebhookHandler,
  findDelegationBufferPda: () => findDelegationBufferPda,
  findDelegationMetadataPda: () => findDelegationMetadataPda,
  findDelegationRecordPda: () => findDelegationRecordPda,
...
var DELEGATION_PROGRAM_ID = new import_web33.PublicKey(
  "DELeGGvXpWV2fqJUhqcF5ZSYMS4JTLjteaAMARRSaeSh"
);
var PERMISSION_PROGRAM_ID = new import_web33.PublicKey(
...
var TEE_VALIDATOR = new import_web33.PublicKey(
...
function createPERConnection() {
  return new import_web33.Connection(PER_ENDPOINT, {
    commitment: "confirmed",
    wsEndpoint: PER_WS_ENDPOINT
  });
}
function createBaseConnection() {
  return new import_web33.Connection("https://api.devnet.solana.com", "confirmed");
}
var PrivacyFeatures = {
