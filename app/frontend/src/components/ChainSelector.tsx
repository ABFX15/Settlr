    ...
    <div className="relative">
      <button
        ...
        className={`
          ...
          ${
            disabled
              ? "bg-[#f2f2f2] border-[#d3d3d3] cursor-not-allowed opacity-50"
              : "bg-[#f2f2f2] border-[#d3d3d3] hover:border-[#d3d3d3] cursor-pointer"
          }
        `}
      >
        ...
        <span className="text-[#212121] font-medium">{selectedInfo.name}</span>
        <svg
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-48 bg-white border border-[#d3d3d3] rounded-lg shadow-xl z-50 overflow-hidden"
          >
            {availableChains.map((chain) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-[#212121]">{info.name}</span>
                  {isSelected && (
                    <svg
                      className="w-4 h-4 text-[#2ba048] ml-auto"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
