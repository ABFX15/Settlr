...
export function PrivacyBadge({
  ...
  if (!isPrivate) {
    return (
      <span
        className={`inline-flex items-center ${sizeClasses[size]} rounded-full bg-[#F5F5F5] text-[#7C8A9E]`}
      >
  ...
  return (
    <div className="relative inline-block">
      <motion.button
        ...
        className={`inline-flex items-center ${sizeClasses[size]} rounded-full bg-[#1B6B4A]/15 border border-[#a78bfa]/30 text-[#155939] cursor-pointer hover:border-[#a78bfa]/50 transition-colors`}
        whileHover={{ scale: 1.02 }}
        whileTap={{ scale: 0.98 }}
      >
        <ShieldCheck size={iconSizes[size]} className="text-[#155939]" />
      ...
      {showDetails && showTooltip && (
        ...
        >
          <div className="space-y-3">
            <div className="flex items-center gap-2 text-[#155939] font-medium">
              <Shield size={16} />
              ...
              <div className="pt-2 border-t border-[#E2E2D1]">
                {revealed ? (
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[#155939] font-mono font-medium">
                      {decryptedAmount}
                    </span>
                  </div>
                ) : (
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 py-2 rounded bg-[#1B6B4A]/15 border border-[#a78bfa]/30 text-[#155939] text-xs hover:bg-[#1B6B4A]/25 transition-colors disabled:opacity-50"
                  >
                    {isDecrypting ? (
                      <>
                        <motion.div
            ...
            <a
              ...
              className="block text-xs text-[#155939] hover:text-[#155939]/80"
            >
  ...
  return (
    <div className="grid md:grid-cols-2 gap-4">
      ...
      <div className="p-4 rounded-lg bg-[#F5F5F5] border border-[#E2E2D1]">
        ...
        <div className="space-y-2 text-sm">
          <div className="flex justify-between">
            ...
            <span className="text-[#155939] font-mono">{publicAmount}</span>
          </div>
          <div className="flex justify-between">
      ...
      <div className="p-4 rounded-lg bg-[#1B6B4A]/[0.06] border border-[#a78bfa]/20">
        <div className="flex items-center gap-2 mb-3 text-[#155939] font-medium">
          <ShieldCheck size={16} />
          Private Receipt (PER)
        </div>
        <div className="space-y-2 text-sm">
          ...
          <div className="flex justify-between">
            <span className="text-[#7C8A9E]">Visibility:</span>
            <span className="text-[#155939]">Only you & merchant</span>
          </div>
        </div>
        <div className="mt-3 pt-3 border-t border-[#a78bfa]/20">
          {showDecrypted ? (
            <div className="flex justify-between items-center">
              ...
              <span className="text-[#155939] font-mono">
            ...
            <button
              ...
              className="w-full text-xs py-1.5 rounded bg-[#1B6B4A]/15 text-[#155939] hover:bg-[#1B6B4A]/25 transition-colors"
            >
              🔓 Simulate Decrypt
            </button>
          )}
      ...
      <div className="p-4 font-mono text-xs space-y-2">
        ...
        <div className="pl-2 space-y-1">
          {isPrivate ? (
            <>
              <div>
                <span className="text-[#155939]">encrypted_amount_handle</span>
              ...
              <div>
                <span className="text-[#155939]">customer</span>
                <span className="text-[#7C8A9E]">: </span>
                <span className="text-[#155939]">&quot;8xPb...7Kq&quot;</span>
              </div>
              <div>
                <span className="text-[#155939]">merchant</span>
                <span className="text-[#7C8A9E]">: </span>
                <span className="text-[#155939]">&quot;3nKq...2Rm&quot;</span>
              </div>
            ...
            <>
              <div>
                <span className="text-[#155939]">amount</span>
                <span className="text-[#7C8A9E]">: </span>
