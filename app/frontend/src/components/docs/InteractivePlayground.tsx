...
export function InteractivePlayground({
  ...
  return (
    <div className="rounded-2xl border border-[#E2DFD5] bg-[#0d0d14] overflow-hidden">
      {/* Header */}
      <div className="flex items-center justify-between border-b border-[#E2DFD5] bg-[#FDFBF7] px-4 py-3">
        ...
        {showExamples && (
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 rounded-lg border border-[#E2DFD5] bg-[#F3F2ED] px-3 py-1.5 text-sm text-[#0C1829] transition-colors hover:bg-[#F3F2ED]"
            >
            ...
            <AnimatePresence>
              {showExampleDropdown && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  className="absolute right-0 top-full z-50 mt-2 w-56 rounded-xl border border-[#E2DFD5] bg-[#12121a] p-2 shadow-xl"
                >
      ...
      <div className="grid lg:grid-cols-2">
        {/* Code Editor */}
        <div className="border-b border-[#E2DFD5] lg:border-b-0 lg:border-r">
          <div className="flex items-center justify-between border-b border-[#E2DFD5] px-4 py-2">
            ...
            <div className="flex gap-2">
              <button
                onClick={handleReset}
                className="rounded p-1.5 text-[#7C8A9E] transition-colors hover:bg-[#F3F2ED] hover:text-[#0C1829]"
                title="Reset"
              >
          ...
          {/* Action Bar */}
          <div className="flex items-center justify-between border-t border-[#E2DFD5] px-4 py-3">
          ...
          <div className="flex items-center justify-between border-b border-[#E2DFD5] px-4 py-2">
            ...
            {showPreview && (
              <button
                ...
                className="rounded p-1 text-[#7C8A9E] transition-colors hover:bg-[#F3F2ED] hover:text-[#0C1829]"
              >
                <X className="h-4 w-4" />
              </button>
            )}
      ...
      {/* Footer */}
      <div className="border-t border-[#E2DFD5] bg-[#FDFBF7] px-4 py-3">
        <div className="flex items-center justify-between text-xs text-[#7C8A9E]">
          ...
          <a
            href="/demo"
            className="text-[#1B6B4A] transition-colors hover:text-[#1B6B4A]/80"
          >
  ...
  if (step === "email") {
    return (
      <motion.div
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
        className="w-full space-y-4 rounded-xl border border-[#E2DFD5] bg-[#12121a] p-4"
      >
        ...
        <input
          ...
          className="w-full rounded-lg border border-[#E2DFD5] bg-[#F3F2ED] px-4 py-3 text-[#0C1829] placeholder:text-[#7C8A9E] focus:border-purple-500/50 focus:outline-none"
        />
        <button
  ...
  if (step === "payment") {
    return (
      <motion.div
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
        className="w-full space-y-3 rounded-xl border border-[#E2DFD5] bg-[#12121a] p-4"
      >
        <div className="text-center">
          <p className="text-lg font-semibold text-[#0C1829]">
            ${amount.toFixed(2)}
        ...
        <div className="space-y-2">
          ...
          <button
            onClick={onConfirmPayment}
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-[#E2DFD5] py-3 font-semibold text-[#0C1829] transition-colors hover:bg-[#F3F2ED]"
          >
  ...
  if (step === "processing") {
    return (
      <motion.div
        initial={{ opacity: 0, scale: 0.95 }}
        animate={{ opacity: 1, scale: 1 }}
        className="w-full space-y-4 rounded-xl border border-[#E2DFD5] bg-[#12121a] p-6 text-center"
      >
  ...
  if (step === "success") {
    return (
      ...
      >
        ...
        <div className="rounded-lg bg-[#FDFBF7]/20 px-3 py-2 font-mono text-xs text-[#1B6B4A]">
          tx: 5Kj2...x8mN
        </div>
      </motion.div>
    );
