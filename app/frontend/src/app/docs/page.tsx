  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background text-foreground pt-16">
        <div className="flex">
          {/* Sidebar */}
          <aside className="hidden lg:block fixed left-0 top-16 bottom-0 w-64 border-r border-border bg-card overflow-y-auto">
            <div className="p-4">
              {/* Search */}
              <div className="relative mb-6">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-border bg-muted py-2 pl-10 pr-4 text-sm text-foreground placeholder:text-muted-foreground/50 focus:border-primary/50 focus:outline-none"
                />
              </div>
          ...
          <main className="flex-1 lg:ml-64">
            <div className="max-w-4xl mx-auto px-6 py-12">
              ...
              <div className="flex gap-1 mb-8 border-b border-border overflow-x-auto lg:hidden">
                {docsTabs.map((tab) => (
                  <button
                    key={tab.id}
                    onClick={() => setActiveTab(tab.id as typeof activeTab)}
      ...
      <section>
        ...
        <div className="mb-8">
          ...
          <div className="mt-4 bg-muted rounded-lg p-4">
            <p className="text-muted-foreground/70 text-sm mb-2">You&apos;ll receive:</p>
            <ul className="text-muted-foreground text-sm space-y-1">
              <li>
                • <span className="text-primary font-mono">API Key</span> -
                Your secret key for SDK initialization
              </li>
              <li>
                • <span className="text-primary font-mono">Merchant ID</span>{" "}
      ...
      Pay $10.00
        ...
        <div className="mb-8">
          ...
          <div className="mt-4 grid md:grid-cols-2 gap-4">
            ...
            <div className="bg-muted rounded-lg p-4">
              <p className="text-accent font-medium mb-1">Cross-chain USDC</p>
              <p className="text-muted-foreground/70 text-sm">
      ...
      <section>
        ...
        <div className="bg-muted border border-border rounded-lg p-4 mb-8">
          ...
          <ol className="text-muted-foreground text-sm space-y-2">
            ...
            <li>
              2. Install the SDK:{" "}
              <code className="text-accent bg-card px-2 py-0.5 rounded">
          ...
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-gray-800">
              ...
              <tr>
                ...
                <td className="px-4 py-3 text-muted-foreground">'USDC' | 'SOL'</td>
                <td className="px-4 py-3 text-muted-foreground">
              ...
              <tr>
                ...
                <td className="px-4 py-3 text-muted-foreground">(tx) =&gt; void</td>
                <td className="px-4 py-3 text-muted-foreground">
              ...
              <tr>
                ...
                <td className="px-4 py-3 text-muted-foreground">(err) =&gt; void</td>
                <td className="px-4 py-3 text-muted-foreground">
              ...
              <tr>
                <td className="px-4 py-3 font-mono text-primary">memo</td>
                <td className="px-4 py-3 text-muted-foreground">string</td>
                <td className="px-4 py-3 text-muted-foreground">
              ...
              <tr>
                <td className="px-4 py-3 font-mono text-primary">gasless</td>
...
function APIContent() {
    ...
    <div className="space-y-8">
      <section>
        ...
        <div className="bg-muted rounded-lg p-4 mb-6">
          <p className="text-muted-foreground/70 text-sm mb-1">Base URL</p>
          <code className="text-primary">https://api.settlr.io/v1</code>
        </div>
  ...
  "expiresAt": "2024-01-15T12:00:00Z"
        ...
        <div className="border border-border rounded-lg overflow-hidden mb-6">
          ...
          <div className="p-4">
            <p className="text-muted-foreground mb-4">Retrieve a payment by ID.</p>
  ...
  return (
    <div className="space-y-8">
      <section>
        ...
        <p className="text-muted-foreground mb-6">Common issues and how to fix them.</p>
...
function CodeBlock({
  ...
  const highlightCode = (code: string, lang: string) => {
    ...
    return code.split("\n").map((line, lineIndex) => {
      ...
      if (line.trim().startsWith("//")) {
        return (
          <div key={lineIndex} className="text-muted-foreground/70">
            {line}
          </div>
        );
      }
        ...
        <div key={lineIndex}>
          {tokens.map((token, tokenIndex) => {
            switch (token.type) {
              ...
              case "string":
                return (
                  <span key={tokenIndex} className="text-primary">
                    {token.value}
                  </span>
                );
              case "comment":
                return (
                  <span key={tokenIndex} className="text-muted-foreground/70">
                    {token.value}
                  </span>
                );
              case "number":
              ...
              case "builtin":
                return (
                  <span key={tokenIndex} className="text-accent">
                    {token.value}
                  </span>
                );
              case "react":
              ...
              default:
                return (
                  <span key={tokenIndex} className="text-foreground/80">
                    {token.value}
                  </span>
                );
            }
  ...
  return (
    <div className="relative bg-muted rounded-lg overflow-hidden mb-4 border border-border">
      <div className="flex items-center justify-between px-4 py-2 bg-card/70 border-b border-gray-700">
        <span className="text-xs text-muted-foreground uppercase font-medium">
          {language}
        </span>
        <button
          onClick={handleCopy}
          className="text-xs text-muted-foreground hover:text-white transition-colors px-2 py-1 rounded hover:bg-gray-700"
        >
          {copied ? "✓ Copied" : "Copy"}
        </button>
      </div>
