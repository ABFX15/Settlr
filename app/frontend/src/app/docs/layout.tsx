...
export const metadata: Metadata = {
  ...
  description:
    "Integrate Offbank non-custodial USDC settlement in under 30 minutes. REST API, webhooks, and React components for high-risk B2B settlement on Solana.",
  keywords: [
  ...
  return (
    <>
      ...
      <div className="sr-only" aria-hidden="true">
        <h1>Offbank Documentation, Settlement API Reference</h1>
        <p>
          Integrate Offbank non-custodial USDC settlement in under 30 minutes.
