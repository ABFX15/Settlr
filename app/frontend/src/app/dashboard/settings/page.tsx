  ...
  return (
    <div className="flex h-[60vh] flex-col items-center justify-center text-center">
      <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-[#34c759]/10">
        <Settings className="h-10 w-10 text-[#34c759]" />
      </div>
      <h1 className="mb-3 text-2xl font-bold">Settings Coming Soon</h1>
      <p className="mb-6 max-w-sm text-sm text-[#8a8a8a]">
        Account settings, notification preferences, and security options will be
        available here.
      </p>
      <Link
        href="/dashboard"
        className="rounded-xl bg-[#34c759] px-6 py-3 text-sm font-semibold text-[#212121] transition-colors hover:bg-[#2ba048]/80"
      >
        ← Back to Dashboard
      </Link>
    </div>
