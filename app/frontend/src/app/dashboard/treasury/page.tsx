      ...
      <div>
        <div className="mx-auto max-w-2xl">
          ...
          <div className="rounded-xl border border-white/10 bg-white/[0.02] p-8 text-center">
            <Wallet className="mx-auto h-10 w-10 text-white/20 mb-4" />
      ...
      <div>
        <div className="mx-auto max-w-2xl">
          ...
          <div className="rounded-xl border border-white/10 bg-white/[0.02] p-8 text-center">
            {loading ? (
              <>
                <RefreshCw className="mx-auto h-8 w-8 text-white/20 mb-4 animate-spin" />
                <p className="text-sm text-white/50">Loading treasury...</p>
              </>
            ) : (
              <>
                <Wallet className="mx-auto h-8 w-8 text-white/20 mb-4" />
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-white/50 mt-1">Manage your payout balance</p>
          </div>
          <button
            onClick={fetchBalance}
            disabled={loading}
            className="inline-flex items-center gap-2 rounded-lg border border-white/10 bg-white/5 px-4 py-2 text-sm text-white/70 hover:bg-white/10 transition-colors"
          >
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-8">
          ...
          >
            ...
            <div className="text-xs text-white/30 mt-1">Ready for payouts</div>
          </motion.div>
          ...
          >
            ...
            <div className="text-xs text-white/30 mt-1">In-flight payouts</div>
          </motion.div>
          ...
          <motion.div
            ...
            className="rounded-xl border border-blue-500/20 bg-blue-500/[0.05] p-6"
          >
            <div className="flex items-center gap-2 text-sm text-blue-400/70 mb-1">
            ...
            <div className="text-xs text-white/30 mt-1">Lifetime deposits</div>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-2 text-sm text-purple-400/70 mb-1">
            ...
            {depositInfo && (
              ...
              >
                ...
                <div className="flex items-center gap-2 rounded-lg border border-white/10 bg-white/5 px-3 py-2.5">
                  <code className="flex-1 text-xs text-white/70 break-all font-mono">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    placeholder="100.00"
                    className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2.5 text-sm text-white placeholder-white/30 focus:border-[#3B82F6]/50 focus:outline-none"
                  />
                </div>
                <div>
                  <label className="block text-xs text-white/50 mb-1">
                  ...
                  <input
                    ...
                    placeholder="5Uh8..."
                    className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2.5 text-sm text-white placeholder-white/30 focus:border-[#3B82F6]/50 focus:outline-none font-mono"
                  />
                </div>
                <button
                      ...
                      >
                        <div
                          className={`rounded-lg p-2 ${
                            isCredit ? "bg-emerald-500/10" : "bg-white/5"
                          }`}
                        >
                        ...
                        <div className="text-right shrink-0">
                          <div
                            className={`text-sm font-medium ${
                              isCredit ? "text-emerald-400" : "text-white/70"
                            }`}
                          >
                            {isCredit ? "+" : "-"}
                            {formatUSD(tx.amount)}
