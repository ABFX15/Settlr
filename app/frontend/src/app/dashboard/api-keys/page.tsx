...
export default function ApiKeysPage() {
  ...
  const getTierColor = (tier: string) => {
    switch (tier) {
      ...
      default:
        return "bg-[#F3F4F6] text-[#7C8A9E] border-[#E5E7EB]";
    }
  };
    ...
    <div>
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="flex items-center justify-between">
            ...
            <motion.button
              ...
              disabled={!connected}
              className="px-6 py-3 bg-[#FFFFFF] text-black font-semibold rounded-xl flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        >
          {loading ? (
            <div className="flex items-center justify-center py-12">
              <div className="w-8 h-8 border-2 border-[#E5E7EB] border-t-white rounded-full animate-spin" />
            </div>
          ) : !connected ? (
            <div className="text-center py-12 bg-white/[0.02] rounded-2xl border border-[#E5E7EB]">
              ...
              return (
                <motion.div
                  ...
                  className={`p-6 rounded-2xl border transition-all ${
                    key.active
                      ? "bg-white/[0.02] border-[#E5E7EB]"
                      : "bg-white/[0.01] border-[#E5E7EB]/[0.04] opacity-60"
                  }`}
                >
                  <div className="flex items-center justify-between">
        ...
        <motion.div
          ...
          className="mt-8 p-6 bg-white/[0.02] rounded-2xl border border-[#E5E7EB]"
        >
          ...
          <div className="grid grid-cols-3 gap-4">
            {[
              ...
              <div key={t.tier} className="p-4 bg-[#F3F4F6] rounded-xl">
      ...
      {/* Create Key Modal */}
      {showCreateModal && (
        <div className="fixed inset-0 bg-[#FFFFFF]/80 flex items-center justify-center p-4 z-50">
          <motion.div
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            className="bg-[#F3F4F6] rounded-2xl border border-[#E5E7EB] p-6 w-full max-w-md"
          >
            {newlyCreatedKey ? (
              <>
                ...
                <div className="p-4 bg-[#F3F4F6] rounded-xl font-mono text-sm break-all mb-4">
                  {newlyCreatedKey}
                </div>

                <button
                  onClick={() => copyKey(newlyCreatedKey)}
                  className="w-full py-3 bg-[#FFFFFF] text-black font-semibold rounded-xl flex items-center justify-center gap-2 mb-3"
                >
                  {copied ? (
                    <>
                ...
                <button
                  ...
                  className="w-full py-3 bg-[#F3F4F6] text-[#0C1829] font-semibold rounded-xl"
                >
                  Done
                </button>
              </>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-[#F3F4F6] border border-[#E5E7EB] rounded-xl text-[#0C1829] placeholder-[#7C8A9E] focus:outline-none focus:border-[#a78bfa]/40"
                    />
                  </div>
                        ...
                        <button
                          ...
                          className={`p-3 rounded-xl border text-sm font-medium transition-all ${
                            newKeyTier === tier
                              ...
                              : "bg-[#F3F4F6] text-[#7C8A9E] border-[#E5E7EB] hover:border-[#E5E7EB]"
                          }`}
                        >
                  ...
                  <div className="flex gap-3 pt-4">
                    <button
                      ...
                      className="flex-1 py-3 bg-[#F3F4F6] text-[#0C1829] font-semibold rounded-xl"
                    >
                      Cancel
                    </button>
                    <button
                      ...
                      className="flex-1 py-3 bg-[#FFFFFF] text-black font-semibold rounded-xl disabled:opacity-50"
                    >
