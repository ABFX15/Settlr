    ...
    >
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-6">
          ...
          <Reveal delay={0.05}>
            <h1 className="max-w-3xl text-[clamp(2rem,5vw,3.5rem)] font-semibold leading-[1.1] tracking-tight">
              ...
              <span className="text-[#1B6B4A]">by email, instantly</span>
            </h1>
          </Reveal>
      ...
      <section className="border-y border-[#E2DFD5]/[0.04]">
        <div className="mx-auto max-w-4xl px-6 py-28">
          ...
          <Reveal delay={0.1}>
            <div className="mt-12 overflow-hidden rounded-2xl border border-[#E2DFD5]">
              <div className="grid grid-cols-4 border-b border-[#E2DFD5] bg-white/[0.02]">
                <div className="p-4 text-xs font-medium text-[#7C8A9E]" />
                <div className="p-4 text-center text-xs font-semibold text-[#7C8A9E]">
                  PayPal
                </div>
                <div className="p-4 text-center text-xs font-semibold text-[#7C8A9E]">
                  Wire
                </div>
                <div className="p-4 text-center text-xs font-semibold text-[#1B6B4A]">
                  Settlr
                </div>
              </div>
              {[
                ...
                <div
                  key={row.label}
                  className={`grid grid-cols-4 border-b border-[#E2DFD5]/[0.03] ${
                    ri % 2 === 0 ? "" : "bg-white/[0.01]"
                  }`}
                >
                  <div className="p-4 text-sm text-[#3B4963]">{row.label}</div>
                  ...
                  <div className="p-4 text-center text-sm font-medium text-[#1B6B4A] bg-[#1B6B4A]/[0.03]">
                    {row.values[2]}
                  </div>
                </div>
              ))}
        ...
        <div className="mx-auto max-w-3xl px-6 py-28 text-center">
          <Reveal>
            <h2 className="text-3xl font-semibold tracking-tight md:text-4xl">
              ...
              <span className="text-[#1B6B4A]">broken payout rails</span>
            </h2>
          </Reveal>
          <Reveal delay={0.05}>
