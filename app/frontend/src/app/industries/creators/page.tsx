...
const features = [
  {
    ...
    description:
      "Fans pay without purchase details on statements. FHE-encrypted receipts.",
    stat: "100%",
    statLabel: "private",
  },
  {
    ...
    description:
      "Crypto payments can't be frozen or banned. Your revenue is yours.",
    stat: "0",
  ...
  },
  {
    ...
    description:
      "Fans pay with email. No MetaMask, no crypto knowledge needed.",
    stat: "3x",
  ...
  },
  {
    icon: DollarSign,
    title: "2% Flat Fee",
    description: "Lower than OnlyFans (20%), Patreon (12%), or Gumroad (10%).",
    stat: "2%",
    statLabel: "that's it",
  },
  {
...
const painPoints = [
  {
    icon: Ban,
    problem: "Platform Risk",
    detail: "One policy change = income gone",
  },
  {
    icon: Eye,
    problem: "Privacy Issues",
    detail: "Purchases visible on statements",
  },
  {
    icon: DollarSign,
    problem: "Massive Fees",
    detail: "Platforms take 10-20% cut",
  },
  {
    icon: Clock,
    problem: "Slow Payouts",
    detail: "Wait 7-30 days for your money",
  },
  {
    icon: Shield,
    problem: "Chargebacks",
    detail: "Lose money months after sale",
  },
];
...
const useCases = [
  ...
  { name: "Online Courses", icon: Users },
  { name: "Private Communities", icon: Heart },
];
          ...
          <div className="grid min-h-[80vh] items-center gap-12 lg:grid-cols-2">
            ...
            >
              ...
              <p className="mb-8 max-w-lg text-lg text-gray-400">
                Non-custodial payments with private transactions, instant
                payouts, and 2% fees. No platform can deplatform you.
              </p>
              ...
              <div className="grid gap-4">
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <p className="text-gray-400">
                      Get paid the moment a sale happens. No waiting 30 days. No
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <div className="text-sm text-gray-400">Be deplatformed</div>
                  </motion.div>
                </div>
              </div>
            </motion.div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          >
            <h2 className="mb-4 text-4xl font-bold text-gray-900 md:text-5xl">
              Platforms take your money
              <span className="text-red-500"> and your freedom</span>
            </h2>
            <p className="mx-auto max-w-2xl text-gray-600">
              Traditional creator platforms charge excessive fees, hold your
              money, and can shut you down without warning.
            </p>
          </motion.div>
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          >
            ...
            <h2 className="mb-4 text-4xl font-bold text-white md:text-5xl">
              ...
              <br />
              <span className="text-[#14F195]">value independence</span>
            </h2>
          </motion.div>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          >
            <h2 className="mb-4 text-4xl font-bold text-white">
              Platform Fees vs. <span className="text-[#00D4FF]">Settlr</span>
            </h2>
          </motion.div>
          ...
          >
            ...
            {[
              { platform: "OnlyFans", fee: "20%", keep: "80%" },
              { platform: "Patreon", fee: "12%", keep: "88%" },
              { platform: "Gumroad", fee: "10%", keep: "90%" },
              { platform: "Ko-fi", fee: "5%", keep: "95%" },
            ].map((row, index) => (
              <div
                key={row.platform}
      ...
      <section className="relative overflow-hidden px-4 py-24">
        ...
        >
          ...
          <p className="mb-8 text-lg text-gray-400">
            Join creators who've chosen financial independence. No platform can
