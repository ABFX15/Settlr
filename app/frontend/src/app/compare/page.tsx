...
export default function ComparePage() {
  return (
    <main
      className="relative min-h-screen bg-[#FFFFFF] text-[#3B4963] antialiased"
            ...
            <ul className="space-y-1.5 text-xs leading-relaxed text-[#7C8A9E]">
              <li>
                ...
                <a
                  ...
                  className="underline hover:text-[#3B4963]"
                >
                  stripe.com/pricing
                </a>{" "}
                and{" "}
        ...
        <div className="mx-auto max-w-3xl px-6 py-24 text-center">
          ...
          <Reveal delay={0.1}>
            <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
              <Link
                href="/onboarding"
                className="inline-flex items-center gap-2 rounded-xl px-7 py-3.5 text-[15px] font-semibold text-white shadow-lg shadow-[#1B6B4A]/25 transition-transform hover:scale-[1.02] active:scale-[0.98]"
                style={{
                  background:
